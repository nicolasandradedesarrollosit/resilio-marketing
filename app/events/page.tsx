    ...
    >
      ...
      <div className="relative w-full px-5 md:px-8 mt-8 md:mt-12 py-8 md:py-16 lg:py-20 border-b border-white/10 shrink-0">
        <div className="max-w-7xl mx-auto text-center md:text-left">
          ...
          <p className="text-xs md:text-lg text-white/60 max-w-2xl mx-auto md:mx-0 leading-relaxed">
            Descubre las experiencias y eventos que te acercarán a la comunidad
            creativa de Resilio.
          </p>
        </div>
      ...
      <div className="flex-1 overflow-y-auto w-full px-5 md:px-8 py-8 md:py-16 lg:py-20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-10 md:mt-20 p-6 md:p-12 rounded-xl md:rounded-2xl bg-gradient-to-r from-dull-lavender-600/20 to-dull-lavender-500/10 border border-dull-lavender-500/30 text-center">
            <h2 className="text-sm md:text-3xl font-bold text-white mb-2 md:mb-4">
              ¿Quieres organizar un evento?
            </h2>
            <p className="text-white/70 text-xs md:text-base mb-4 md:mb-6 max-w-xl mx-auto leading-relaxed">
