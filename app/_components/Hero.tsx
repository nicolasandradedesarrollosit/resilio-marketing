      ...
      <div className="flex flex-col lg:flex-row min-h-screen w-full px-4 md:px-8 lg:px-0">
        <div className="w-full lg:w-1/2 flex justify-center items-center py-8 lg:py-0 mt-24 lg:mt-0">
          <div className="relative group">
            <div
              aria-hidden="true"
              className="absolute -inset-4 bg-gradient-to-r from-dull-lavender-400/30 via-dull-lavender-300/20 to-dull-lavender-500/30 blur-3xl opacity-75 group-hover:opacity-100 transition-opacity duration-500 animate-pulse motion-reduce:animate-none"
            />
            <div
              aria-hidden="true"
              className="absolute -inset-2 bg-gradient-to-br from-white/10 to-transparent rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"
            />
            <Image
              priority
              alt="Resilio Life - Transformamos ideas en experiencias de marketing creativo"
