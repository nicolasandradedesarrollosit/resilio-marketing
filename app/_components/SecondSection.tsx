...
export default function SecondSection() {
  ...
  return (
    ...
    >
      {/* Decorative blobs */}
      <div className="absolute top-10 right-10 w-64 h-64 bg-dull-lavender-500/10 rounded-full blur-3xl animate-pulse" />
      <div className="absolute bottom-20 left-10 w-80 h-80 bg-dull-lavender-400/10 rounded-full blur-3xl animate-pulse delay-1000" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-dull-lavender-600/5 rounded-full blur-3xl" />
