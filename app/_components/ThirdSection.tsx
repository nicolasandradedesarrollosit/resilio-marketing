    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        <div className="text-center mb-12 md:mb-16">
          ...
          <div className="mx-auto w-16 h-0.5 bg-gradient-to-r from-dull-lavender-400 to-dull-lavender-600 rounded-full" />
        </div>
        ...
        >
          {manifestoBlocks.map((block, index) => (
            <motion.div
              key={block.label}
              animate={
                manifestoInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 24 }
              }
              className="flex"
            ...
            >
              <div className="relative flex-1 flex flex-col rounded-2xl bg-white/[0.03] border border-white/[0.06] backdrop-blur-sm overflow-hidden">
                <div className="absolute left-0 top-0 bottom-0 w-[2px] bg-gradient-to-b from-dull-lavender-400 to-dull-lavender-600" />
